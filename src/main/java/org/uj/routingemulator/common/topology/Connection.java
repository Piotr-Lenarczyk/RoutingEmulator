...
import org.uj.routingemulator.common.topology.exceptions.NoNeighborInterfaceException;
...
public record Connection(ConnectionId id, NetworkInterface interfaceA, NetworkInterface interfaceB) {
	 ...
	 * @throws IllegalStateException if connection cannot be established due to interface state
	 */
	 ...
	 * @throws NoNeighborInterfaceException if the given interface is not part of this connection
	 */
